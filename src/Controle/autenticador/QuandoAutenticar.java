...
public class QuandoAutenticar implements ActionListener {

    private Portal portal;
    private VAutenticador aut;

    public QuandoAutenticar(Portal portal, VAutenticador aut) {
        this.portal = portal;
        this.aut = aut;
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(autenticou){
        aut.habilitarAutenticacao(false);
